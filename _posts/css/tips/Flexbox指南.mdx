...
![Flexbox](https://pics-rust.vercel.app/20181016105026.png)
...
![image](https://pics-rust.vercel.app/20181020205051.png)
...
![image](https://pics-rust.vercel.app/20181020205713.png)

### 水平对齐或者垂直对齐

flex-direction 默认是 row，从左向右，当其属性值为 column 时，是从上到下，可以使用 justify-content 和 align-items 改变水平和垂直对齐。

![image](https://pics-rust.vercel.app/20181022100130.png)
...
![image](https://pics-rust.vercel.app/20181022100921.png)
...
![image](https://pics-rust.vercel.app/images/20181022141409.png)
...
![image](https://pics-rust.vercel.app/images/20181022142507.png)

#### align-self-元素使用 align-self 覆盖容器的 align-items 对当前元素的对齐方式

![image](https://pics-rust.vercel.app/images/20181022142842.png)
